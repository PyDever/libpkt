...
# disguise a new packet with new data as the old packet
new_packet = pkt.ip(
    src_ip=pkt.rd_in(packet)['src_ip'], dst_ip=pkt.rd_in(packet)['dst_ip'],
    ip_id=54321, d_hdr=random._urandom(1024)
)
